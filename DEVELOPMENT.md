...
```bash
git remote add encore encore://passport-photo-layout-generator-34xi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/passport-photo-layout-generator-34xi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/passport-photo-layout-generator-34xi/settings/integrations/github)
